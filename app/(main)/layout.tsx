    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <header className="bg-gray-900 flex justify-between items-center bg-primary text-white p-4 shadow">
                ...
                <Button onClick={handleLogOut} className="lg:flex hidden bg-red-500 font-semibold xl:text-lg lg:px-5 px-2 lg:py-3 py-2 text-md hover:cursor-pointer" variant={"destructive"} type="button">Logout</Button>
                ...
                <nav className={`lg:hidden absolute right-3.5 top-15 rounded-lg z-10 p-4 bg-gray-900 border-2 border-blue-300 flex sm:w-[185px] flex-col gap-y-3 text-2xl font-semibold ${displayMenu ? "flex" : "hidden"}`}>
                    ...
                    <Link onClick={() => setDisplayMenu(false)} href={"/create"} className={`${path === "/create" ? "text-primary" : ""}`}>Create</Link>
